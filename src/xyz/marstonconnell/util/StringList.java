...
public class StringList {
	 ...
	 * purposes, this method does not use the fact that the items in the list
	 * are ordered.)
	 * 
	 * @param searchItem
	 *            the item that is to be searched for
	...
	/**
	 * Delete a specified item from the list, if that item is present. If
	 * multiple copies of the item are present in the list, only the one that
	 * comes first in the list is deleted.
	 * 
	 * @param deleteItem
	 *            the item to be deleted
	 * @return true if the item was found and deleted, or false if the item was
	 *         not in the list.
	 */
