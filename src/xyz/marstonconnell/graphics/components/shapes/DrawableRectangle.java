...
public class DrawableRectangle extends Drawable {
	...
	public DrawableRectangle(int x, int y, int width, int height, DrawingLayer drawingLayer, boolean filled,
	...
	public DrawableRectangle(int x, int y, int width, int  height, DrawingLayer drawingLayer, Color color) {
